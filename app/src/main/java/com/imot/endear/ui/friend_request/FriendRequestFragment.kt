...
class FriendRequestFragment : Fragment(), IfirebaseLoadDone {
    ...
    override fun onCreateView(
        ...
        val FriendRequestViewModel =
            ViewModelProvider(this)[FriendRequestViewModel::class.java]

        _binding = FragmentFriendrequestBinding.inflate(inflater,
            container,
            false)
        ...
        FriendRequestViewModel.text.observe(viewLifecycleOwner) {
            ...
            recycler_friend_request = binding.recyclerFriendRequest
            ...
            expandable_search_bar.addTextChangeListener(object : TextWatcher {
                ...
                override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                    ...
                    for (search in suggestList) {
                        if (search.lowercase()
                                .contentEquals(expandable_search_bar.text.lowercase())
                        ) {
                            suggest.plus(search)
                        }
            ...
            expandable_search_bar.setOnSearchActionListener(object :
            ...
            recycler_friend_request.addItemDecoration(DividerItemDecoration(context,
